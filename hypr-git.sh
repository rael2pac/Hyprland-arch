...
packages=(
    ...
    ffmpegthumbnailer breeze breeze5 breeze-icons breeze-gtk qt5ct-kde qt6ct-kde wlogout satty cpio cmake pamixer vulkan-tools imagemagick
...
# --- Executar simple-sddm2-arch.sh se existir ---
if [ -f "$SCRIPT_DIR/simple-sddm2-arch.sh" ]; then
    echo "Executando simple-sddm2-arch.sh..."
    bash "$SCRIPT_DIR/simple-sddm2-arch.sh"
    echo "simple-sddm2-arch.sh concluído."
else
