...
packages=(
    hyprland dolphin dolphin-plugins kde-cli-tools kio unrar unrar-free unzip pacman-contrib kate oh-my-posh-bin cmake cmake-extras fish bc fastfetch inxi
